...
channels = 16
X_1 = MessagePassing.TopQuarkMP(aggregate='sum')([X_in, A_in, E_in])  # GNN layer 1
X_2 = MessagePassing.TopQuarkMP(aggregate='sum')([X_1, A_in, E_in])  # GNN layer 2
X_3 = MessagePassing.TopQuarkMP(aggregate='sum')([X_2, A_in, E_in])  #GNN layer 3
...
dictionary = {"Learning Rate": learning_rate, "Epochs": epochs, "Batch Size": batch_size,
              ...
              "Test Loss": test_loss, "Test Accuracy": test_acc, "t0": t0,
              "Dimension Removed": dim}  # Details about the model
